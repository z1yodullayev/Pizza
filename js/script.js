...
let topArr = [["Pomidor", "tomato"], ["Tuzlangan bodring", "pickle"], ["Kurka go'shti", "turkey"], ["Qo'ziqorn", "mushrooms"], ["Zaytun", "olive"], ["Qazi", "sausage"]];
let extraArr = [["Achchiq", "spicy"], ["Sosiskali", "sosiska"]];
let resultTopArr = [];
let resultExtraArr = [];
